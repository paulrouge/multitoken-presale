...
class TxHandler:
    ...
    def _deploy(self, wallet, to, content, ctype, params, limit):
    ...
    def install(self, wallet, content, ctype='application/zip', params=None, limit=None):
        return self._deploy(wallet, self.SYSTEM_ADDRESS, content, ctype, params, limit)

    def update(self, wallet, to, content, ctype='application/zip', params=None, limit=None):
        return self._deploy(wallet, to, content, ctype, params, limit)
    ...
    def invoke(self, wallet, to, method, params, value=None, limit=None):
